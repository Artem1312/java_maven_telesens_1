...
import com.academy.automationpractice.ddt.core.DetailWebDriverEventListener;
...
public class BaseTest {
    private static Logger LOG = LoggerFactory.getLogger(com.academy.trueconf.core.BaseTest.class);
